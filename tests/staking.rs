...
fn bonding_works() {
    ...
    new_test_ext(vec![SIGNER]).execute_with(|| {
        ...
        let contract = Contract::upload_contract()
            .signer(SIGNER)
            .salt("contract")
            .wasm(demo_staking_broker::WASM_BINARY)
            .upload();
        ...
        assert_eq!(
            ...
            signer_current_balance_at_block_1 - 100 * ONE_TOKEN - gas_fees.burned
        );
        ...
        assert_eq!(
            balance_from_user(SIGNER),
            signer_current_balance_at_block_2 - 100 * ONE_TOKEN - gas_fees.burned
        );
...
//     new_test_ext(vec![SIGNER]).execute_with(|| {
//         let contract = upload_wasm(
//             demo_staking_broker::WASM_BINARY, 
//             SIGNER, 
//             b"contract", 
//             None
//         );
...
//         let result = send_message_and_run_one_block(
//             SIGNER, 
//             &contract, 
//             Request::Bond { 
//                 value: 100 * ONE_TOKEN, 
